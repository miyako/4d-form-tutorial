...
There is no way to preview a drop-down list's actual populated/selected state -- for any of the five kinds -- without running the form interactively. See `98-tool4d-cli.md` for CLI version requirements and static template rendering rules.
