...
- An input supports automatic drag and drop with no extra setup, acting as a mouse-driven substitute for Copy/Cut/Paste (drag text out, drop text/a picture in). Custom drag and drop can transfer any pasteboard data type except file promises, between the object and other areas/applications
